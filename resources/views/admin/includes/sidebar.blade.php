	...
	<div class="sidebar-inner slimscroll">
		<div id="sidebar-menu" class="sidebar-menu">
			...
			<ul>
				...
				@can('view-reports')
				<li class="submenu">
					<a href="#"><i class="fe fe-file-text"></i> <span data-i18n="reports">{{ trans_key('reports') }}</span> <i class="fa fa-chevron-right"></i></a>
					<ul style="display: none;">
				...
				<li class="{{ route_is('backup.index') ? 'active' : '' }}"> 
					<!-- Swapped material icon for feather icon for consistency -->
					<a href="{{route('backup.index')}}"><i class="fe fe-database"></i> <span data-i18n="backups">{{ trans_key('backups') }}</span></a>
				</li>
				@can('view-settings')
